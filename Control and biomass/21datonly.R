...
Gy=drm(IR~RateM, subset=Soybean=="Glyphosate",  fct=l3 (fixed =c(NA,100,NA)), data= Dicam)
modelFit(Gy)
summary(Gy)
...
Gu=drm(IR~RateM, subset=Soybean=="Glufosinate",  fct=l3 (fixed =c(NA,100,NA)), data= Dicam)
modelFit(Gu)
summary(Gu)
...
Cnt=drm(IR~RateM, subset=Soybean=="Conventional",  fct=l3 (fixed =c(NA,100,NA)), data= Dicam)
modelFit(Cnt)
summary(Cnt)
...
Or=drm(IR~RateM, subset=Soybean=="Organic",  fct=l3 (fixed =c(NA,100,NA)), data= Dicam)
modelFit(Or)
summary(Or)
...
Gr=drm(IR~RateM, subset=Soybean=="Grape",  fct=l3 (fixed =c(NA,100,NA)), data= Dicam)
modelFit(Gr)
summary(Gr)
...
Tm=drm(IR~RateM, subset=Soybean=="Tomato",  fct=l3 (fixed =c(NA,100,NA)), data= Dicam)
modelFit(Tm)
summary(Tm)
...
x11()
par(mar=c(5,5,1,2), mgp=c(3.0,1,0))
Gy=drm(IR~RateM, subset=Soybean=="Glyphosate",  fct=l3 (fixed =c(NA,70,NA)), data= Dicam)
modelFit(Gy)
summary(Gy)

plot(Gy, col="orange", legend=F, lty=1, pch=1, cex.axis = 1.8, cex.lab=2, cex=2,
     xlab = expression(paste("Dicamba (g ae ha "^"-1",")")), type="none",
     ylab = expression(paste("Crop Injury (%)")), lwd=5, 
     bp=0.0001, xlim=c(0,100000), ylim=c(0,100))
...
Gu=drm(IR~RateM, subset=Soybean=="Glufosinate",  fct=l3 (fixed =c(NA,70,NA)), data= Dicam)
modelFit(Gu)
summary(Gu)
...
Cnt=drm(IR~RateM, subset=Soybean=="Conventional",  fct=l3 (fixed =c(NA,70,NA)), data= Dicam)
modelFit(Cnt)
summary(Cnt)
...
Gr=drm(IR~RateM, subset=Soybean=="Grape",  fct=l3 (fixed =c(NA,30,NA)), data= Dicam)
modelFit(Gr)
summary(Gr)
...
Tm=drm(IR~RateM, subset=Soybean=="Tomato",  fct=l3 (fixed =c(NA,70,NA)), data= Dicam)
modelFit(Tm)
summary(Tm)
