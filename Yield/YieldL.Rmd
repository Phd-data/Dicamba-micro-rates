...
plot(R2T, xlim=c(0,1000), legendPos = c(10,100), xlab = expression(paste("Dicamba (g ae ha "^"-1",")")), col=c(1,2,3,4), lty=c(1,2,3,4),lwd=2, pch=c(1,2,3,4), ylab = expression(paste("Soybean Yield Loss (%)")))
```
